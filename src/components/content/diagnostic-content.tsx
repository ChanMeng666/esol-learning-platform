...
/**
 * Diagnostic content component for dashboard integration
 * Extracted from /diagnostic page without layout wrapper
 */
export function DiagnosticContent() {
  ...
  function handleStartTest(testId: bigint) {
    router.push(`/student/dashboard/diagnostic/${testId}`);
  }

  function handleViewResults(attemptId: bigint) {
    router.push(`/student/dashboard/diagnostic/results/${attemptId}`);
  }
