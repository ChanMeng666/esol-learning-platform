 ...
 *
 * CEFR-aligned practice for all four skills (A1-C2)
 * Entry point for general ESOL learning path
 */

export default function GeneralPracticePage() {
  return (
    <ProtectedRoute>
      <GeneralPracticePageContent />
    </ProtectedRoute>
  );
}
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {/* Skills Grid */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4">Practice by Skill</h2>
