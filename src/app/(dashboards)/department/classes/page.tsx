      ...
      cell: ({ row }) => (
        <div className="flex gap-2">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push(`/department/classes/${row.original.id}`)}
          >
          ...
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push(`/department/classes/${row.original.id}/edit`)}
          >
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold tracking-tight">Department Classes</h1>
          <p className="text-muted-foreground">
            Manage all classes in your department
          </p>
        </div>
        <Button onClick={() => router.push("/department/classes/new")}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complete list of all department classes
          </CardDescription>
        </CardHeader>
