...
import { type NavGroup, type NavMainItem } from "@/types/navigation";
...
/**
 * Expanded navigation item component (for expanded sidebar)
 */
...
/**
 * Collapsed navigation item component (for collapsed sidebar)
 */
...
/**
 * Main navigation component with grouped items
 */
          ...
          <SidebarGroupContent className="flex flex-col gap-2">
            <SidebarMenu>
              {group.items.map((item) => {
                // Collapsed sidebar (desktop only) - show dropdown for items with subitems
